...
> = {
  ...
  t3_project_list: { displayName: "List T3 projects" },
  t3_project_read: { displayName: "Read a T3 project" },
  t3_project_create: { displayName: "Create a T3 project" },
  t3_project_update: { displayName: "Update a T3 project" },
  t3_project_delete: { displayName: "Delete a T3 project" },
