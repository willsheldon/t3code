...
> = {
  ...
  t3_terminal_list: { displayName: "List managed terminals" },
  t3_terminal_read: { displayName: "Read managed terminal output" },
  t3_terminal_open: { displayName: "Open a managed terminal" },
  t3_terminal_write: { displayName: "Write to a managed terminal" },
  t3_terminal_resize: { displayName: "Resize a managed terminal" },
  t3_terminal_clear: { displayName: "Clear managed terminal output" },
  t3_terminal_restart: { displayName: "Restart a managed terminal" },
  t3_terminal_close: { displayName: "Close a managed terminal" },
  t3_project_script_list: { displayName: "List saved project scripts" },
  t3_project_script_run: { displayName: "Run a saved project script" },
  t3_project_script_stop: { displayName: "Stop a saved project script" },
