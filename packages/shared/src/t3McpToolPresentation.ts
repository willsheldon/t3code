...
> = {
  ...
  t3_pending_request_list: { displayName: "List delegated user-input requests" },
  t3_pending_request_read: { displayName: "Read a delegated user-input request" },
  t3_pending_request_respond: { displayName: "Answer a delegated user-input request" },
