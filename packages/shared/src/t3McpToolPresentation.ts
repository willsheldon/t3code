...
> = {
  ...
  t3_queue_list: { displayName: "List queued T3 work" },
  t3_queue_read: { displayName: "Read queued T3 work" },
  t3_queue_edit: { displayName: "Edit queued T3 work" },
  t3_queue_reorder: { displayName: "Reorder queued T3 work" },
  t3_queue_cancel: { displayName: "Cancel queued T3 work" },
  t3_queue_promote_to_steer: { displayName: "Promote queued T3 work to steer" },
