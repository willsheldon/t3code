...
import * as EnvironmentUsageMcpService from "./EnvironmentUsageMcpService.ts";
import { EnvironmentUsageToolkitHandlersLive } from "./toolkits/environmentUsage/handlers.ts";
import { EnvironmentUsageToolkit } from "./toolkits/environmentUsage/tools.ts";
...
export const EnvironmentUsageToolkitRegistrationLive = McpServer.toolkit(
  EnvironmentUsageToolkit,
).pipe(
  Layer.provide(EnvironmentUsageToolkitHandlersLive),
  Layer.provide(EnvironmentUsageMcpService.layer),
);
...
export const layer = Layer.mergeAll(
  ...
  EnvironmentUsageToolkitRegistrationLive,
