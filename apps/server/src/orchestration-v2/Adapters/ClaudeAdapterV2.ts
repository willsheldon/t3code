...
// Must stay in sync with Tool.Readonly annotations on every registered toolkit;
// ClaudeAdapterV2.test.ts cross-checks this list against the read-only toolkits.
export const CLAUDE_READ_ONLY_T3_MCP_ALLOWED_TOOLS: ReadonlyArray<string> = [
  ...
  "mcp__t3-code__t3_environment_usage",
