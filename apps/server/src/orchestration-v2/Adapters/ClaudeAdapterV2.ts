...
// Must stay in sync with the Tool.Readonly annotations on the registered
// orchestration and terminal toolkits; ClaudeAdapterV2.test.ts cross-checks it.
export const CLAUDE_READ_ONLY_T3_MCP_ALLOWED_TOOLS: ReadonlyArray<string> = [
  ...
  "mcp__t3-code__t3_project_script_list",
  "mcp__t3-code__t3_terminal_list",
