...
capability. Credentials expire after the liveness window without MCP traffic or provider-turn
activity, and provider-session release revokes them eagerly. The raw token is not persisted in
orchestration state.
